...
def retransform_(
    ...
    for i in range(N):
        ...
        if formula == "lin":  # Levels (No Transformation)
            ...
            V[0:T:step, i] = np.add(X[c_idx[0]:H:step, i], Z[c_idx[0] - step:H-step:step, i])
        elif formula == "ch1":
            ...
            V[0:T:step, i] = np.multiply(1 + (X[c_idx[0]:H:step, i] / 100), Z[c_idx[0] - step:H-step:step, i])
            ...
            V[0:T:step, i] = ((1 + X[c_idx[0]:H:step, i] / 100) ** n) * Z[c_idx[0] - step:H-step:step, i]            
